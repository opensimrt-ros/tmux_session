...
tmux send -t ar_session:1.1 "roslaunch gait1992_description fixer_client.launch" C-m
tmux send -t ar_session:1.2 "roslaunch gait1992_description fixer_server.launch" C-m
tmux send -t ar_session:1.3 "roslaunch gait1992_description human_control_imus_movable.launch" C-m

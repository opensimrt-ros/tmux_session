...
FILE=/srv/host_data/tmp/04/test_walking_186/2024-05-13-14-17-46s04_id_walking_filtered_SCRIPT0_1ik.sto
...
tmux send -t mysession:1.0 "sleep 2; rosservice call /ik/out_labels" C-m
tmux send -t mysession:1.1 "rostopic echo /model_generic/joint_states" C-m
tmux send -t mysession:1.2 "roslaunch osrt_ros vis_ik.launch" C-m

tmux send -t mysession:1.3 "roslaunch gait1992_description human_control.launch tf_prefix:=/ik" C-m

tmux send -t mysession:1.4 "roslaunch osrt_ros ik_bare_1992.launch ik_file:=${FILE}" C-m
...
tmux send -t mysession:1.7 "sleep 2.2; rosservice call /ik/inverse_kinematics_from_file/start" C-m

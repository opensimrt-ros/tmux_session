...
tmux send -t mysession:1.2 "roslaunch osrt_ros feet_in_bag_no_tfs.launch" C-m
...
tmux send -t mysession:2.0 "rosrun rviz rviz -d /catkin_ws/_insole_robot_bag.rviz" C-m

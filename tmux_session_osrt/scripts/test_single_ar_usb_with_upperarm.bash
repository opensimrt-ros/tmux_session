...
tmux send -t ar_session:1.3 "roslaunch osrt_ros ik_upper.launch tf_frame_prefix:=ar" C-m
tmux send -t ar_session:1.4 "roslaunch osrt_ros upper_body_tfs.launch name:=ar_marker_10 tf_frame_prefix:=ar" C-m

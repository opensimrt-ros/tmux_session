...
#It doesn't really reach 100"hz" running at 4x
...
"roslaunch custom_clock back_in_time_clock.launch start_at_secs:=$CLOCK_START_SECS start_at_nsecs:=$CLOCK_START_NSECS slowdown_rate:=0.5" 
"rosrun osrt_ros graph_iks_old_filtered.bash"
"rostopic hz /ik/output"
"rostopic hz /ik/output_filtered"
)
W2=(
